...
## Project Overview
While auto theft is a city-wide issue in Toronto, initial exploratory data analysis revealed an extreme spatial anomaly: the **West Humber-Clairville** neighborhood experiences a disproportionately high volume of vehicle thefts compared to the rest of the city. 
...
* **Data Retrieval:** Overpass API (OpenStreetMap) for Points of Interest (POI) extraction
* **Statistical Methods:** Coordinate Vectorization, Distance Matrices, Welch's t-test
...
4. **Hypothesis Testing:** Converted proximity counts into binary indicators based on logical spatial thresholds (e.g., within 1.5 km of an airport). Applied Welch's t-test to determine if the concentration of thefts near these hubs in West Humber is statistically significant compared to the rest of Toronto.

![Statistical Output Example](image_placeholder_1.png)
*(Note: Replace this placeholder with a screenshot of your t-test output or a bar chart comparing the percentages)*
...
* **Airport Long-Term Parking (1.5 km threshold):** * West Humber: 55.6% | Rest of Toronto: 1.7%
  * **P-value:** 0.000
  * *Insight:* A staggering 32x difference indicates large, unmonitored airport parking lots are heavily utilized as temporary "cooling off" storage for stolen vehicles.
...
## Conclusion
By applying rigorous geospatial and statistical analysis, this project validates that West Humber's extreme auto theft rate is not arbitrary. It is mathematically correlated with its unique logistical infrastructure, providing actionable intelligence that could inform targeted law enforcement strategies and urban planning.
